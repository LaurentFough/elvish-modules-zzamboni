...
#+begin_src elvish
use github.com/LaurentFough/elvish-modules-zzamboni/dir
#+end_src
...
If you want the =cd= command to recognize a hyphen as "the previous directory", you need to set up an alias from =cd= to call =dir:cd= instead. You can use the [[https://github.com/LaurentFough/elvish-modules-zzamboni/blob/master/alias.org][alias]] module for this:
...
#+begin_src elvish
alias:new cdb "use github.com/LaurentFough/elvish-modules-zzamboni/dir; dir:cdb"
#+end_src
...
See [[https://github.com/LaurentFough/elvish-modules-zzamboni/blob/master/alias.org][alias.org]] for full usage instructions for the =alias= module.
